...
public class Leilao {
	...
	private String ownerUser; //cpf do usuario q é o owner
	private double minimunPrice;
	private String winnerUser; //usuario vencedor(está sempre sendo atualizado p o q dá o maior lance)
	...
	public void endLeilao() throws SQLException {
		//seta o vencedor, da drop em todos dados da tabela para ter uma tabela nova pra os proximos e encerra a conexão
		actualWinner();
		banco.sair();
	}
	public void saveNewLance( User user, Double value) throws SQLException {
		...
		if(createLance) {
			...
			System.out.println("Valor para lance deve ser maior do que lances já existentes e maior do que o valor minimo");
		}
	}
	...
	public void showAllLances() throws SQLException {
		//mostra todos os lances já feitos(pega do banco)
		this.Lances = banco.listarTodosLances();
		
	}
	public void actualWinner() {
		//diz quem é o vencedor no momento
		Double maior = 0.0;
		String winner = null;
		for (Entry<String, Double> pair : Lances.entrySet()) {
